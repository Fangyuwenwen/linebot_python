...
with open("menu1.jpg", 'rb') as f:
    line_bot_api.set_rich_menu_image("richmenu-8223623957a5adbc56405f0ad8334b76", "image/jpeg", f)"""
...
body = {
    ...
    "richMenuId":"richmenu-8223623957a5adbc56405f0ad8334b76"
}
...
import requests
headers = {"Authorization":"Bearer 4kW19F7L5Yt+DKSvppThCuirviV8iyqGcEYrg8aM2NjaDNl4zyA5fsFebqJusjAEb5CLVAD/dC7eDl3m7E64ByD6qOoUB0h+jyFRZkfq5tZ+gBxdd/adTJri+vdiikYKn9J58RLux6L14oElp7BBRwdB04t89/1O/w1cDnyilFU=","Content-Type":"application/json"}
req = requests.request('POST', 'https://api.line.me/v2/bot/user/all/richmenu/richmenu-8223623957a5adbc56405f0ad8334b76', headers=headers)
print(req.text)
